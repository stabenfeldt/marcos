...
ActiveRecord::Schema.define(version: 20170502094900) do
  ...
  add_index "part_services", ["bike_part_id"], name: "index_part_services_on_bike_part_id", using: :btree
  ...
  add_foreign_key "part_services", "bike_parts"
